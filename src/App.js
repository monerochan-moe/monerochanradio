    ...
    <ToggleContext.Provider value={ toggle }>   
      <div className="App" beach={ toggle === false ? "1" : "0"}>
        <DarkModeToggle
                  ...
                  text-align="left"
                  /> 
          <a href="https://thetendiefren.co/" text-align="right" target="_blank"><img className="pepe" src="https://siasky.net/BAAjTZYF9KFBbs8eKJn7Kons1ArdcrWQ4WNlZc3EfSht_w" alt="Pepe" text-align="right"/> </a> 
